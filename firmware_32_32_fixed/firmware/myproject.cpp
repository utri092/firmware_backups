...
//  #pragma HLS INTERFACE ap_vld port=input1,layer10_out
    ...
    if (!loaded_weights) {
        ...
        nnet::load_weights_from_txt<model_default_t, 4>(w2, "w2.txt");
        nnet::load_weights_from_txt<model_default_t, 2>(b2, "b2.txt");
        nnet::load_weights_from_txt<model_default_t, 10>(w4, "w4.txt");
        nnet::load_weights_from_txt<model_default_t, 5>(b4, "b4.txt");
        nnet::load_weights_from_txt<model_default_t, 25>(w6, "w6.txt");
        nnet::load_weights_from_txt<model_default_t, 5>(b6, "b6.txt");
        nnet::load_weights_from_txt<model_default_t, 25>(w8, "w8.txt");
        nnet::load_weights_from_txt<model_default_t, 5>(b8, "b8.txt");
        nnet::load_weights_from_txt<model_default_t, 5>(w10, "w10.txt");
